  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Tab.Screen
          options={{
            tabBarIcon: ({ focused }) => <Feather name="search" size={26} color={focused ? "#fff" : "#b3b3b3"} />,
          }}
          name="Search"
          component={Home}
        />
        <Tab.Screen
          options={{
            tabBarIcon: ({ focused }) => (
              <Ionicons name="library-outline" size={26} color={focused ? "#fff" : "#b3b3b3"} />
            ),
          }}
          name="Your Library"
          component={Home}
        ...
        <Tab.Screen
          options={{
            tabBarIcon: ({ focused }) => <Fontisto name="spotify" size={26} color={focused ? "#fff" : "#b3b3b3"} />,
          }}
          name="Premium"
          component={Home}
        />
